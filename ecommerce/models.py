...
class Product(models.Model):
    ...
    quantity_min = models.IntegerField(default=0, null=True, blank=True)
    unit = models.CharField(max_length=200, default='Piece')
    is_pro = models.BooleanField(default=False)
    supplier = models.ForeignKey(Profil, on_delete=models.SET_NULL, default=None, null=True, blank=True)
...
class MessageSupplier(models.Model):
    ...
    message = models.TextField()
    date_add = models.DateField(auto_now_add=True)
    supplier = models.ForeignKey(Profil, on_delete=models.CASCADE)
