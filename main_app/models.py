...
type_customer = (('Ordinary', 'Ordinary'), ('Professional', 'Professional'), ('Supplier', 'Supplier'))
...
class Profil(models.Model):
    ...
    type_customer = models.CharField(max_length=20, choices=type_customer, default='Ordinary')
